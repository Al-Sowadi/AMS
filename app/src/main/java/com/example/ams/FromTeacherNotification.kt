...
class FromTeacherNotification : Fragment() {
    ...
    override fun onCreateView(
        ...
        val viewT  = inflater.inflate(R.layout.fragment_from_teacher_notification, container, false)
        val databaseToday = FirebaseDatabase.getInstance()
        val myRefToday = databaseToday.getReference("AllData/FromStuff")
...
//            println(formatter.format(date))
        ...
        val recyclerviewToday = viewT.findViewById<RecyclerView>(R.id.recyclerviewTf)
        recyclerviewToday?.layoutManager = LinearLayoutManager(viewT.context)
